...
export default function RecuInterne() {
    ...
    useEffect(() => {
        const fetchInterventions = async () => {
            try {
                ...
                const interneInterventions = response.data.filter(intervention => intervention.workflow === 'interne');
                const updatedInterventions = await Promise.all(interneInterventions.map(async intervention => {
        ...
        <Layout>
            <div className="mt-8 flex justify-center">
                <div className="w-full bg-white p-4 rounded-lg shadow-md">
                    ...
                    <hr className="mt-5" />
                    <h2 className="mt-5 text-2xl font-bold">Liste des articles à expédier aux réparateurs internes</h2>
